...
<br>
<p style="color:  #6a3332;">{{ __('lang.maketxt') }}</p>
<img src="https://www.voguehk.com/media/2020/11/Hourglass_RHW_Ambient-Lighting-Blush-Sublime-Flush-VOGUE-HK-EXCLUSIVE...-1024x1280.jpg" style="width: 200px; height: 250px; margin-left: 100px;">
<canvas id="myChart3" width="200" height="100" style="width:200px; height=100px"></canvas>
<script>
var ctx = document.getElementById('myChart3').getContext('2d');
var myChart3 = new Chart(ctx, {
    type: 'line',
    data: {
        labels: ['14-18 y.o','18-25 y.o','25-30 y.o','30-40 y.o', '40-50 y.o'],
  datasets: [{
    label: 'Age categories of clients who do makeup',
    data: [70, 80, 60, 55, 40],
    fill: false,
    borderColor: '#6a3332',
    tension: 0.1
    ...
    @if(session('success'))
      ...
      <div class="form-group">
                ...
                <select id="procedure_name" name="procedure_name" class="form-control">
                    <option value="{{ __('lang.make') }}">{{ __('lang.make') }}</option>
                </select>
