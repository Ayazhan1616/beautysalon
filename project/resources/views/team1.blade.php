    ...
    <header class="header" id="header">
        <div class="content-wrapper">
            ...
            <nav class="navigation">
                <ul class="nonelist">
                    <li>
                        <a data-section-item="uvod" href="http://project/public/main" style="text-decoration: none; color: white;">
                        {{ __('lang.home') }}
                        </a>
                    </li>
    
                    <li>
                        <a data-section-item="o-salone" href="http://project/public/main#o-salone" style="text-decoration: none; color:  white;"> 
                        {{ __('lang.about') }}
                        </a>
                    </li>
    
                    <li>
                        <a data-section-item="osetrenia" href="http://project/public/main#osetrenia" style="text-decoration: none; color:  white;">
                        {{ __('lang.procedures') }}
                        </a>
                    </li>
    
                    <li>
                        <a data-section-item="predaj" href="http://project/public/main#predaj" style="text-decoration: none; color:  white;">
                        {{ __('lang.team') }}
                        </a>
                    </li>
    
                    <li>
                        <a data-section-item="kontakt" href="http://project/public/main#kontakt" style="text-decoration: none; color:  white;">
                        {{ __('lang.contact') }}
                        </a>
                    </li>
                </ul>
...
<div id="page">
    ...
    <div id="content" class="content">
        ...
        <br>
        <h4 class="text-color-white has-text-centered" style=" margin-left:10px;color: #6a3332">
    {{ __('lang.uploadwarning') }}
    </h4>
