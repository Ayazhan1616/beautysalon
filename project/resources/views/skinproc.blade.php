...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['Chemical Peel', 'Botox Injections', 'Dermabrasion', 'Laser Skin Resurfacing', 'Dermal Fillers', 'Microdermabrasion'],
        datasets: [{
            label: 'Popularity of skin treatments',
            data: [12, 19, 8, 10, 6, 8],
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
